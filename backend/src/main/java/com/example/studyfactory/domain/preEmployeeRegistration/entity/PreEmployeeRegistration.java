package com.example.studyfactory.domain.preEmployeeRegistration.entity;
...
@Getter
@Entity
@Table(name = "pre_employee_registrations")
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class PreEmployeeRegistration extends BaseEntity {
    ...
    public PreEmployeeRegistration(
            Long branchId,
            Long employeeTypeId,
            String name,
            int seatNumber,

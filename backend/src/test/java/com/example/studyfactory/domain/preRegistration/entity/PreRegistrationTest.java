...
class PreRegistrationTest {
    ...
    void createPreRegistrationFromRequest() {
        ...
        assertThat(preRegistration.getDrinkSetting()).isEqualTo("아이스 아메리카노");
        assertThat(preRegistration.getDrinkNote()).isEqualTo("연하게");
        assertThat(preRegistration.getMemberNote()).isEqualTo("오전 교육 예정");
    }
}
